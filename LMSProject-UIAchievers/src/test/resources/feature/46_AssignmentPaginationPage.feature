...
Given Admin is on Dashboard page after Login to check 
 When Admin clicks "Assignment" button in the Navigation bar to check
 
 Scenario: Verify sheet one is displayed on default in Assigment data table
 Then Data table should display 1 page of assignment when entries available
 
 Scenario: Verify right arrow is enable when sheet one is displayed in Assigment data table
 Then Right arrow should be enabled in page one when of page entries are more than 5 available
 
 Scenario: Verify left arrow is disable when sheet one is displayed in Assigment data table
 Then Left arrow should be disabled in assign page one when entries are more than 5 available
 
 Scenario: Verify right arrow is enable when sheet two is displayed in Assigment data table when entries are more than 10
 Then Right arrow should be enabled in assignment page two when entries are more than 10 available
 
 Scenario: Verify left arrow is enable when sheet two is displayed in Assigment data table
 Then Left arrow should be enabled in adminassign page two 
 
 Scenario: Verify right arrow is disable when sheet two is displayed in Assigment data table when entries are less than 10
