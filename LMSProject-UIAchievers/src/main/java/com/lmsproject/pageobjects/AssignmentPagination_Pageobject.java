...
public class AssignmentPagination_Pageobject {
	WebDriver driver;
	Actions action;
	String successpage="";


public AssignmentPagination_Pageobject(WebDriver driver)
{ 
...
@FindBy (xpath="//a[contains(text(),'Add New Assignment')]")WebElement addNewAssignButton;
...
public void ClickonAssignPageLink()
{
	assign.isEnabled();
}
public void CheckOnAssignPageLink()
{
	assign.isDisplayed();
}
...
public void ClickaddNewAssignButton()
{
	addNewAssignButton.click();
}
